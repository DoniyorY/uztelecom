...
function latcyr () {
    ...
    car = car.replace(/\n /g, "\n");
    document.transliteration.kyril.value=car;
}
function cyrlat () {
    car = document.transliteration.kyril.value;
    ...
    car = car.replace(/Ю/g, "Yu");
    car = car.replace(/Ц/g, "Ts");
    document.transliteration.lotin.value=car;
}
function copy1()
{ textRange=document.transliteration.kyril.createTextRange();   textRange.execCommand("Copy");   textRange="";
}
function copy2()
{ textRange=document.transliteration.lotin.createTextRange();   textRange.execCommand("Copy");   textRange="";
}